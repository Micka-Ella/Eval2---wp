...
const migrateTicketCosts = () => {
  ...
  const migrations = [
    ...
    ['is_cancelled', 'ALTER TABLE ticket_costs ADD COLUMN is_cancelled INTEGER NOT NULL DEFAULT 0'],
    ['cancelled_at', 'ALTER TABLE ticket_costs ADD COLUMN cancelled_at TEXT'],
  ];
